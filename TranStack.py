...
from TS_settings import verbose, wavelength_min, wavelength_max


# DO NOT EDIT #
# editable global settings can be found in TS_settings.py
...
if len(Filters)>1:
    ...
    stacks = []
    TS_gui.addStack()
    butStack.on_clicked(TS_fio.addStack)
